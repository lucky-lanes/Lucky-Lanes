...
public class IBSSN {
    ...
    /**
     * User-entered target accuracy score, values 0.0 to 10.0
     */
    private double targetAccuracy = 0;
    
    /**
     * User-entered target accuracy score, values 0 to 100%
     */
    private double pocketPercentage = 0;
    
    /**
     * User-entered single pin spare conversion score, values 0 to 100%
     */
    private double singlePinSpareConv = 0;
    
    /**
     * User-entered multiple pin spare conversion score, values 0 to 100%
     */
    private double multiplePinSpareConv = 0;
    
    /**
     * User-entered number of throws to pocket, values 1 to 10
     */
    private int avgThrowsToPocket = 0;
    
    /**
     * User-entered number of throws to pocket after adjustment, values 1 to 10
     */
    private int avgThrowsToPocketAdjusted = 0;
    
    /**
     * User-entered entry angle of ball, values 0 to 10.0 
     */
    private double entryAngle = 0;
    
    /**
     * User-entered ball speed consistency, values 0.0 to 1
     */
    private double ballSpeedConsistency = 0;
    
    /**
     * User-entered ball speed at release, values 0 and above
     */
    ...
    /**
     * User-entered rev rate at release, values 0 and above
     */
     ...
     * @param pocketPercentage
     * @param singlePinSpareConv
     * @param multiplePinSpareConv
     * @param avgThrowsToPocket
     * @param avgThrowsToPocketAdjusted
     * @param entryAngle
     * @param ballSpeedConsistency
     * @param ballSpeed
    ...
    public void addRow(boolean viewInfo, String DBindex) {
        if (viewInfo == false) {
            ...
            sql = "INSERT INTO IBSSN VALUES ("
                    + "null, " + this.targetAccuracy + ", " + this.pocketPercentage + ", " + this.singlePinSpareConv +
                    ", " + this.multiplePinSpareConv + ", " + this.avgThrowsToPocket + ", " + this.avgThrowsToPocketAdjusted + 
                    ", " + this.entryAngle + "," + this.ballSpeedConsistency +", " + this.ballSpeed + ", " + this.gender 
                    + ", " + this.revRate + ");";
        ...
        if (viewInfo == true) {
            ...
            sql = "UPDATE IBSSN SET " +
                    ...
                    ", pocketPercentage = " + this.pocketPercentage +
                    ", singlePinSpareConv = " + this.singlePinSpareConv +
                    ", multiplePinSpareConv = " + this.multiplePinSpareConv +
                    ", avgThrowsToPocket = " + this.avgThrowsToPocket +
                    ", avgThrowsToPocketAdjusted = " + this.avgThrowsToPocketAdjusted + 
                    ", entryAngle = " + this.entryAngle +
                    ", ballSpeedConsistency = " + this.ballSpeedConsistency +
    ...
    public void setTotalPoints(){
        ...
        this.totalPoints[0] += calculateTargetAccuracyPoints();
        this.totalPoints[1] += calculatePocketPercentagePoints();
        this.totalPoints[2] += calculateSinglePinSparePoints();
        this.totalPoints[3] += calculateMultiPinSparePoints();
        this.totalPoints[4] += calculateNoAdjustVersatilityPoints();
        this.totalPoints[5] += calculateLaneAdjustVersatilityPoints();
        this.totalPoints[6] += calculateEntryAnglePoints();
        this.totalPoints[7] += calculateBallSpeedConsistPoints();
        this.totalPoints[8] += calculateBallSpeedReleasePoints();
        this.totalPoints[9] += calculateRevRateReleasePoints();
        
        for(int i = 0; i < 10; i++) {
        	this.totalPoints[10] += this.totalPoints[i];
        }
